...
به اطلاع می‌رساند که نسخه جدید تقویم فارسی (امروز) برای ساعت‌های Amazfit به‌زودی منتشر خواهد شد. شما می‌توانید این برنامه را از طریق اپلیکیشن Zepp در گوشی خود دانلود و روی ساعتتان نصب کنید.
